...
ERR(ModifyAttributeMismatch) =  { "V", "0090", "Input modify flag doesn't match builtin type" };
ERR(ToggleAttributeMismatch) =  { "V", "0100", "Input toggle flag doesn't match builtin type" };
